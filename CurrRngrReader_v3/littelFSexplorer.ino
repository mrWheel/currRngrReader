...
bool handleFile(String &&path) {
  ...
  if (!LittleFS.exists("littleFSexplorer.html")) httpServer.send(200, "text/html", LittleFS.begin() ? HELPER : WARNING);     // ermöglicht das hochladen der littleFSexplorer.html
