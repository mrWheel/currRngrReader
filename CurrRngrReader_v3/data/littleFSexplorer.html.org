...
<html lang="de">
  ...
  <body>
    ...
    <form action="/format" method="POST">
	  ...
	  <button id="btn">List LittleFS</button>
	</form>
	<hr>
  <div style='width: 30%'>
  <form style='float: left;' action='/ReBoot' method='POST'>ReBoot 
      <input type='submit' class='button' name='SUBMIT' value='ReBoot' />
  </form>
  
  <form style='float: right;' action='/' method='POST'> &nbsp; Exit FSexplorer
     <input type='submit' class='button' name='SUBMIT' value='Exit' />
    </form>
  </div>
